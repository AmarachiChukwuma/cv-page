  ...
  return (
    <div className='w-[90px] flex justify-center items-center '>
        ...
        <div className='flex pt-4 gap-7 mb-10 text-[23px]'>
            ...
            <IoLogoLinkedin cursor-pointer hover:scale-110 translate-all ease-out/>
            <IoMailOpen cursor-pointer hover:scale-110 translate-all ease-out/>
            <IoLogoWhatsapp cursor-pointer hover:scale-110 translate-all ease-out/>
            <IoLogoInstagram cursor-pointer hover:scale-110 translate-all ease-out/>
        </div>
